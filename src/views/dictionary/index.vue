<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-permission="['sys:dictionary:delete']" :disabled="batchDeleteButtonStatus" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleDelete()">
        {{ $t('table.batchDelete') }}
      </el-button>
    </div>
    <el-table
    ...
    >
      <el-table-column
        ...
        width="55"
      />
      <!-- <el-table-column :label="$t('dictionaryInfo.id')" align="center">
      ...
      <el-table-column :label="$t('dictionaryInfo.createTime')" align="center" width="160">
        <template slot-scope="scope">
