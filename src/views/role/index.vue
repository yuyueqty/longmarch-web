<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-permission="['sys:role:delete']" :disabled="batchDeleteButtonStatus" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleDelete()">
        {{ $t('table.batchDelete') }}
      </el-button>
    </div>
    <el-table
